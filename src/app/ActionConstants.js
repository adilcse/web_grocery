...
export const CATAGORIES_LOADED='CATAGORIES_LOADED';
...
export const SET_CURRENT_LOCATION_FAILED='SET_CURRENT_LOCATION_FAILED';

export const SET_CURRENT_ADDRESS_PENDING='SET_CURRENT_ADDRESS_PENDING';
export const SET_CURRENT_ADDRESS_SUCCESS='SET_CURRENT_ADDRESS_SUCCESS';
export const SET_CURRENT_ADDRESS_FAILED='SET_CURRENT_ADDRESS_FAILED';

export const GET_SELLERS_PENDING='GET_SELLERS_PENDING';
export const GET_SELLERS_SUCCESS='GET_SELLERS_SUCCESS';
export const GET_SELLERS_FAILED='GET_SELLERS_FAILED';

export const GET_ALL_PRODUCT_PENDING='GET_PRODUCT_PENDING';
export const GET_ALL_PRODUCT_SUCCESS='GET_PRODUCT_SUCCESS'; 
export const GET_ALL_PRODUCT_FAILED='GET_PRODUCT_FAILED';
